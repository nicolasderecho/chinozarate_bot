...
def test_games_message(mocker):
    ...
    for message in messages_to_test:
        ...
        assert re.search('mega\.nz\/#F!or41ESyb!H7_bZCtA4ubFm8qygjJk5Q', channel.mock.call_args_list[0][0][0], re.IGNORECASE) != None